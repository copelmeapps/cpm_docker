...
POSTGRESQL_MAX_LOCKS_PER_TRANSACTION="${POSTGRESQL_MAX_LOCKS_PER_TRANSACTION:-"${POSTGRES_MAX_LOCKS_PER_TRANSACTION:-}"}"
export POSTGRESQL_MAX_LOCKS_PER_TRANSACTION="${POSTGRESQL_MAX_LOCKS_PER_TRANSACTION:-}"
POSTGRESQL_MAX_WAL_SIZE="${POSTGRESQL_MAX_WAL_SIZE:-"${POSTGRES_MAX_WAL_SIZE:-}"}"
export POSTGRESQL_MAX_WAL_SIZE="${POSTGRESQL_MAX_WAL_SIZE:-}"