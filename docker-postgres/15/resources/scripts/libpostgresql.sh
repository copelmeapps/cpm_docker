...
postgresql_initialize() {
    ...
    is_boolean_yes "$create_conf_file" && postgresql_configure_local_parameters
...
########################
# Change postgresql.conf by setting change max locks per transaction
# Globals:
#   POSTGRESQL_*
# Arguments:
#   None
...
#   None
#########################
postgresql_configure_local_parameters(){
    info "Configuring local parameters"
    postgresql_set_property "max_locks_per_transaction" "$POSTGRESQL_MAX_LOCKS_PER_TRANSACTION"
    postgresql_set_property "max_wal_size" "$POSTGRESQL_MAX_WAL_SIZE"
}